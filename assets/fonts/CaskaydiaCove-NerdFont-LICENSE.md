...
frext bundles the Nerd Fonts-patched Cascadia Code regular font file
(`CaskaydiaCoveNerdFont-Regular.ttf`). The patched font files are distributed by the
...
Nerd Fonts patch renames the patched family to **"CaskaydiaCove"** — frext
